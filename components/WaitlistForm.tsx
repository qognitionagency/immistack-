  ...
  if (status === CRMStatus.SUCCESS) {
    return (
      <div className="bg-white p-8 text-center h-full flex flex-col items-center justify-center min-h-[400px]">
        ...
        <h3 className="text-2xl font-heading font-bold text-navy mb-2">Trial Activated!</h3>
        <p className="text-gray-500 mb-8 max-w-xs mx-auto">
          Your trial has been set up and a lead has been created in Zoho CRM. 
          One of our enterprise specialists will contact you at <span className="font-semibold text-navy">{formData.email}</span> within 24 hours.
        </p>
